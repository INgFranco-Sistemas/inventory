...
<template>
    <div>
        <VCard title="🏬 Almacenes">
            <VCardText>
                <VRow class="justify-space-between">
                    <VCol cols="3">
                        <VTextField Placeholder="Search Warehouses" density="compact" class="me-3" v-model="searchQuery"
                            @keyup.enter="list" />
                    </VCol>
            ...
            <VDataTable :headers="headers" :items="list_warehouses" :items-per-page="5" class="text-no-wrap">
        ...
        <WarehouseAddDialog v-model:isDialogVisible="isWarehouseAddDialogVisible" :sucursales="list_sucursales" @addWarehouse="addNewWarehouse">
        </WarehouseAddDialog>
        <WarehouseEditDialog v-if="warehouse_selected_edit && isWarehouseEditDialogVisible" :sucursales="list_sucursales"
            v-model:isDialogVisible="isWarehouseEditDialogVisible" :warehouseSelected="warehouse_selected_edit"
            @editWarehouse="addEditWarehouse"></WarehouseEditDialog>
        <WarehouseDeleteDialog v-if="warehouse_selected_delete && isWarehouseDeleteDialogVisible"
            v-model:isDialogVisible="isWarehouseDeleteDialogVisible" :warehouseSelected="warehouse_selected_delete"
            @deleteWarehouse="addDeleteWarehouse"></WarehouseDeleteDialog>
    </div>
</template>
