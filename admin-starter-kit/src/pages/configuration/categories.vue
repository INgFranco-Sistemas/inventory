...
<template>
    <div>
        <VCard title="🎫 Categorias">
            <VCardText>
                <VRow class="justify-space-between">
                    <VCol cols="3">
                        <VTextField Placeholder="Search Categorie" density="compact" class="me-3" v-model="searchQuery"
                            @keyup.enter="list" />
                    </VCol>
            ...
            <VDataTable :headers="headers" :items="list_categories" :items-per-page="5" class="text-no-wrap">
        ...
        <CategorieEditDialog v-if="categorie_selected_edit && isCategorieEditDialogVisible"
            ...
            @editCategorie="addEditCategorie"></CategorieEditDialog>
        <CategorieDeleteDialog v-if="categorie_selected_delete && isCategorieDeleteDialogVisible"
            ...
            @deleteCategorie="addDeleteCategorie"></CategorieDeleteDialog>
    </div>
</template>
